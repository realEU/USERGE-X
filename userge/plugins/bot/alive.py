...
async def send_alive_message(message: Message) -> None:
    ...
    if client.is_bot:
        ...
        caption += (
            f"\n🔊  <a href='https://tx.me/MarineBots'><b>CHANNEL</b></a>"
            "    <code>|</code>    "
            "🦋  <a href='https://tx.me/MarineChats'><b>SUPPORT</b></a>"
        )
...
def _parse_arg(arg: bool) -> str:
    return "❕Enabled❕" if arg else "❗️Disabled❗️"
...
"""
    ...
    def alive_buttons() -> InlineKeyboardMarkup:
        buttons = [
            [
                InlineKeyboardButton(text="⚰️ Stats ⚰️", callback_data="settings_btn"),
